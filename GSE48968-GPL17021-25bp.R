...
write.csv(Runtime_table, "~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Runtime_table.csv")
pdf("~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Runtime.pdf")
boxplot(Runtime_table$Runtime, outline=FALSE, main = "Runtime", xlab = "GSE48968-GPL17021-25bp", ylab = "Seconds", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Precision_table, "~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Precision_table.csv")
pdf("~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Precision.pdf")
boxplot(Precision_table$Precision, outline=FALSE, main = "Precision", xlab = "GSE48968-GPL17021-25bp", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Recall_table, "~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Recall_table.csv")
pdf("~/Desktop/glm()_project/GSE48968-GPL17021-25bp/Recall.pdf")
boxplot(Recall_table$Recall, outline=FALSE, main = "Recall", xlab = "GSE48968-GPL17021-25bp", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(F1score_table, "~/Desktop/glm()_project/GSE48968-GPL17021-25bp/F1score_table.csv")
pdf("~/Desktop/glm()_project/GSE48968-GPL17021-25bp/F1score.pdf")
boxplot(F1score_table$F1score, outline=FALSE, main = "F1score", xlab = "GSE48968-GPL17021-25bp", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(AUC_table, "~/Desktop/glm()_project/GSE48968-GPL17021-25bp/AUC_table.csv")
pdf("~/Desktop/glm()_project/GSE48968-GPL17021-25bp/AUC.pdf")
boxplot(AUC_table$AUC, outline=FALSE, main = "AUC", xlab = "GSE48968-GPL17021-25bp", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
