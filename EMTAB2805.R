...
write.csv(Runtime_table, "~/Desktop/glm()_project/EMTAB2805/Runtime_table.csv")
pdf("~/Desktop/glm()_project/EMTAB2805/Runtime.pdf")
boxplot(Runtime_table$Runtime, outline=FALSE, main = "Runtime", xlab = "EMTAB2805", ylab = "Seconds", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Precision_table, "~/Desktop/glm()_project/EMTAB2805/Precision_table.csv")
pdf("~/Desktop/glm()_project/EMTAB2805/Precision.pdf")
boxplot(Precision_table$Precision, outline=FALSE, main = "Precision", xlab = "EMTAB2805", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Recall_table, "~/Desktop/glm()_project/EMTAB2805/Recall_table.csv")
pdf("~/Desktop/glm()_project/EMTAB2805/Recall.pdf")
boxplot(Recall_table$Recall, outline=FALSE, main = "Recall", xlab = "EMTAB2805", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(F1score_table, "~/Desktop/glm()_project/EMTAB2805/F1score_table.csv")
pdf("~/Desktop/glm()_project/EMTAB2805/F1score.pdf")
boxplot(F1score_table$F1score, outline=FALSE, main = "F1score", xlab = "EMTAB2805", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(AUC_table, "~/Desktop/glm()_project/EMTAB2805/AUC_table.csv")
pdf("~/Desktop/glm()_project/EMTAB2805/AUC.pdf")
boxplot(AUC_table$AUC, outline=FALSE, main = "AUC", xlab = "EMTAB2805", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
