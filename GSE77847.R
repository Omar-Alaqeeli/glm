...
write.csv(Runtime_table, "~/Desktop/glm()_project/GSE77847/Runtime_table.csv")
pdf("~/Desktop/glm()_project/GSE77847/Runtime.pdf")
boxplot(Runtime_table$Runtime, outline=FALSE, main = "Runtime", xlab = "GSE77847", ylab = "Seconds", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Precision_table, "~/Desktop/glm()_project/GSE77847/Precision_table.csv")
pdf("~/Desktop/glm()_project/GSE77847/Precision.pdf")
boxplot(Precision_table$Precision, outline=FALSE, main = "Precision", xlab = "GSE77847", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(Recall_table, "~/Desktop/glm()_project/GSE77847/Recall_table.csv")
pdf("~/Desktop/glm()_project/GSE77847/Recall.pdf")
boxplot(Recall_table$Recall, outline=FALSE, main = "Recall", xlab = "GSE77847", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(F1score_table, "~/Desktop/glm()_project/GSE77847/F1score_table.csv")
pdf("~/Desktop/glm()_project/GSE77847/F1score.pdf")
boxplot(F1score_table$F1score, outline=FALSE, main = "F1score", xlab = "GSE77847", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
...
write.csv(AUC_table, "~/Desktop/glm()_project/GSE77847/AUC_table.csv")
pdf("~/Desktop/glm()_project/GSE77847/AUC.pdf")
boxplot(AUC_table$AUC, outline=FALSE, main = "AUC", xlab = "GSE77847", ylab = "Score", col=c("#800020")) #outline=FALSE to remove extreme values
